...
cmp word[width_protection], 1

jne skipChecks
	cmp word[field_width], 15
	jge sc1
	mov ax, 0x4C00
	int 0x21

sc1:
	cmp word[field_width], 38
	jle skipChecks
...
lewp:
	...
	startIteration:
		...
		checkSides:
			...
			jnz checkWalls
			cmp word[ball_motion], -158
			jnz sk1
			call incP1
			sk1:
			cmp word[ball_motion], 162
			jnz sk2
			call incP1
			sk2:
			cmp word[ball_motion], 158
...
crText: db 'By Muhammad Ibrahim Shahbaz(23F-0590)', 0
P1: db '               ', 0
P2: db '               ', 0
